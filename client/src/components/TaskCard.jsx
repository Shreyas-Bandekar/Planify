...
const TaskCard = ({ task, onEdit, onDelete, onToggleComplete }) => {
  ...
  return (
    <div className={`group relative bg-white/80 backdrop-blur-sm rounded-xl sm:rounded-2xl border border-gray-200/50 p-4 sm:p-6 hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 ${
      ...
      <div className="relative">
        <div className="flex items-start justify-between mb-3 sm:mb-4">
          <div className="flex items-center space-x-2 sm:space-x-3 flex-1 min-w-0">
            <button
              ...
              className={`relative w-5 h-5 sm:w-6 sm:h-6 rounded-full border-2 flex items-center justify-center transition-all duration-300 hover:scale-110 flex-shrink-0 ${
                task.completed
        ...
        <h3 className={`font-bold text-gray-900 mb-2 sm:mb-3 text-base sm:text-lg leading-tight ${
